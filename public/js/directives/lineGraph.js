...
angular.module('tdf').directive('lineGraph',
    ...
    function($window, $timeout, d3Service) {
        return {
			...
			{
				test.push((k+1)*100);
				thePoints = thePoints + test[k] + ", " + data[i].score[k] + " "
			}		
			return thePoints;
			})
			.style('fill', 'none')
			...
			svg.selectAll('line')
                        ...
                        .enter()
                        .append('line')
                        .attr("x1", function(d,i){return 150;})
                        .attr("y1", function(d,i){return 150;})
                        .attr("x2", function(d,i){return 150;})
                        .attr("y2", function(d,i){return 150;})
			.attr("stroke","black")
			.attr("stroke-width",lineWidth);
